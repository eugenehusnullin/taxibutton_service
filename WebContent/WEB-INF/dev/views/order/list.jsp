	...
	$(document)
			.ready(
					...
					function() {
						...
						$("tr.sortableHead").find("a:not(.notSorted)").click(
								function() {

									if ($("input#orderDirection").val() == "desc") {
										$("input#orderDirection").val("asc");
									} else {
										$("input#orderDirection").val("desc");
									}

									$(this).attr(
											"href",
											getListRef($("input#start").val(),
													$(this).attr("id")), $("input#orderDirection").val());
								});
...
<body>
	...
	<input type="hidden" id="orderDirection" value="${orderDirection}">
	<input type="hidden" id="start" value="${start}">
	<input type="hidden" id="count" value="${count}"> Show by
